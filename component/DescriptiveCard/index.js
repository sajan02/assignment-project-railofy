...
export default function index(props) {
    const { Title, Year, Rated, Released, Runtime, Genre, Director, Actors, Language, Poster, Rating,
        imdbRating, DVD, Plot,
    } = props;
    return (
  <div className="custom-container">
    ...
    <div className="description">
      ...
      <div className="column">
          {
              Actors.split(',').filter(d => d)
              .map(d =>
              <span className="tag actor">{d}</span>)
          }
      </div>
    </div>
  </div>
